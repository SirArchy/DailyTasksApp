...
import com.example.dailytasktest.databinding.FragmentHelpfeedbackBinding
...
class HelpFeedbackFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val slideshowViewModel =
            ViewModelProvider(this).get(HelpFeedbackViewModel::class.java)

        _binding = FragmentHelpfeedbackBinding.inflate(inflater, container, false)
        val root: View = binding.root

        val textView: TextView = binding.textHelpFeedback
